...
class User < ActiveRecord::Base
  ...
  validates_length_of :name,:within =>1..  4,:on => :update,:message => "真实姓名会使朋友更快找到你，Michael.me会保护你的隐私，不要担心"
  validates_length_of :city,:within => 2..5,:message => "便于Michael.me识别你周围的朋友",:on => :update
